...
export default function Terms() {
  return (
    <LegalLayout title="Términos y condiciones" lastUpdated="2026-04-23">
      ...
      <h2>4. Limitación de responsabilidad — DEPORTES DE RIESGO</h2>
      <p><strong>WindFlowRadar es una herramienta informativa.</strong> Los datos meteorológicos pueden contener errores, retrasos o imprecisiones. No deben usarse como única fuente para decisiones críticas de seguridad. <strong>La práctica de windsurf, kitesurf, vela u otros deportes acuáticos conlleva riesgos. El usuario es el único responsable de evaluar las condiciones reales y su propia capacidad.</strong> En la máxima medida permitida por la ley, declinamos toda responsabilidad por daños derivados del uso de la información.</p>
